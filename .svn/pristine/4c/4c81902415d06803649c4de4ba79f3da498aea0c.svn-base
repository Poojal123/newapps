...
<!-- <script type="text/javascript" src="<?php echo base_url();?>assets/scripts/vControls/vcRadio/vcRadio.js"></script>
 ...
 <script type="text/javascript" src="<?php echo base_url();?>assets/scripts/vControls/vcFile/vcFile.js"></script>
  ...
  <script type="text/javascript" src="<?php echo base_url();?>assets/scripts/CASA/services.js"></script>
  <script type="text/javascript" src="<?php echo base_url();?>assets/scripts/CASA/controllers.js"></script>

  <script type="text/javascript" src="<?php echo base_url();?>assets/scripts/OCTM/services.js"></script>
  <script type="text/javascript" src="<?php echo base_url();?>assets/scripts/OCTM/controllers.js"></script>
  ...
  <script type="text/javascript" src="<?php echo base_url();?>assets/scripts/JLA/services.js"></script>
  <script type="text/javascript" src="<?php echo base_url();?>assets/scripts/JLA/controllers.js"></script>

  <script type="text/javascript" src="<?php echo base_url();?>assets/scripts/TechnicalScrutiny/services.js"></script>
  <script type="text/javascript" src="<?php echo base_url();?>assets/scripts/TechnicalScrutiny/controllers.js"></script>

  <script type="text/javascript" src="<?php echo base_url();?>assets/scripts/PDCCTS/services.js"></script>
  <script type="text/javascript" src="<?php echo base_url();?>assets/scripts/PDCCTS/controller.js"></script>
  
  <script type="text/javascript" src="<?php echo base_url();?>assets/scripts/GOLDBOND/services.js"></script>
  <script type="text/javascript" src="<?php echo base_url();?>assets/scripts/GOLDBOND/controllers.js"></script>

 <script type="text/javascript" src="<?php echo base_url();?>assets/scripts/PLDE/services.js"></script>
  <script type="text/javascript" src="<?php echo base_url();?>assets/scripts/PLDE/controllers.js"></script>
